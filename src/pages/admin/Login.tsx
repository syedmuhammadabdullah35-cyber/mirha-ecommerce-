    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-primary p-4">
      <div className="max-w-md w-full bg-white p-12 border border-brand-gold/20 shadow-2xl space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-500 text-sm">Please sign in with authorized admin account to manage Mirha By Insaf.</p>
        </div>
        ...
        <a href="/" className="flex items-center justify-center space-x-2 text-xs uppercase tracking-widest text-gray-400 hover:text-brand-dark transition-all">
          <ChevronLeft size={14} />
