...
export function AdminLayout() {
  ...
  // Temporary admin bypass (always true)
  const isActualAdmin = true;

  useEffect(() => {
    // Admin login redirection disabled temporarily
    /*
    ...
    <div className="min-h-screen bg-gray-50 flex">
          ...
          <div className="flex items-center space-x-3 px-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-white/40 truncate">
                {user?.email || 'insafclothhouse1718@gmail.com'}
              </p>
            </div>
          </div>
      ...
      <main className="flex-1 ml-72 p-12">
        ...
        <header className="flex justify-between items-center mb-12">
          ...
          <Link
            to="/"
            className="flex items-center space-x-2 text-xs uppercase font-bold tracking-widest text-brand-gold hover:underline"
          >
            <Home size={14} />
